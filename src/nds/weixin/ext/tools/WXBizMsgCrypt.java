...
public class WXBizMsgCrypt {
	...
	public String decryptMsg(String text) throws AesException {
		...
		System.out.println("from_appid_>"+from_appid+",appid->"+appId);
		// appid不相同的情况
	 ...
	 * @throws AesException 执行失败，请查看该异常的错误码和具体的错误信息
	 */
	public boolean verifyMsg(String msgSignature, String timeStamp, String nonce, String postData)
			throws AesException {
		// 验证安全签名
		String signature = SHA1.getSHA1(token, timeStamp, nonce, postData);
		System.out.println("st->"+signature);
	...
	public boolean verifyUrl(String msgSignature, String timeStamp, String nonce, String echoStr)
		...
		System.out.println("dsignature->"+signature);
